...
let createOtherTasks = () => {
    ...
    function createTask() {
        ...
        taskSubmit.addEventListener('click', function enter() {
            if(document.getElementById('taskField').value === '' || priorityCheck === false ||  priorityValue === 'NA'){
                return
            } 
                else{
        ...
        let priorityPlaceHolderText = document.createTextNode('Select Priority Level')
